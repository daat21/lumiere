...
import { getGenresList, getMovieDetailsByIds, getPopularMovies } from '@/lib/tmdb'
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <div>
        ...
        {userWatchlist.length>0?(<Suspense fallback={<div>Loading...</div>}>
          <WatchlistCarousel movies={userWatchlist} />
        </Suspense>):(<div className="my-10 flex flex-col items-center gap-4">
          <p>
